...
export const rules: RuleDetails[] = [
  ...
  },
  {
    ...
    summaryInfo: `החוק מעגן את חוק השיוויון כחוק יסוד. לכן כל החתולים מתיישרים על קו שווה ממנו הם ממשיכים באותה מהירות שהיתה להם לפני קבלת החוק.`,
    impact: { all: 0 },
  ...
  },
  {
    ...
    summaryInfo: `ההצבעה מבטלת את כל החוקים שהתקבלו עד עכשו. כל החתולים נעים מהמקום אליו הגיעו במהירות אחידה.`,
    impact: { all: 0 },
    apply: { type: "Reset" },
    isDelayed: true,
    icon:"reset",
