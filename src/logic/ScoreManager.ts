...
export class ScoreManager {
  ...
  static SUMMARY_TEXTS = [
    ...
    [
      ...
      {
        firstLine: "הצלחת לא רע! והצלחת להעביר מגוון של חתולים ממגדרים ומגזרים שונים. ",
        secondLine: " כדאי לנסות לשפר.",
      },
      {
    ...
    [
      ...
      {
        firstLine:
          "כל הכבוד! אין כמוך... ואפילו הצלחת להעביר מגוון של חתולים ממגדרים ומגזרים שונים.",
        secondLine: "כדאי לשתף את התוצאה.",
      },
      {
        firstLine:
